        ...
        <div className="clean-card rounded-[24px] overflow-hidden flex flex-col h-full bg-white transition-all duration-300 group-hover:shadow-xl relative">
          ...
          <div className="relative aspect-[4/3] bg-gray-50 overflow-hidden border-b border-gray-100">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-2 z-20">
              <span className="bg-white/90 backdrop-blur-md text-gray-900 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg border border-white/50">
                {product.condition}
              </span>
              {product.isVerified && (
                <span className="bg-blue-600/95 backdrop-blur-md text-white px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-600/20 flex items-center gap-1.5 border border-blue-500">
